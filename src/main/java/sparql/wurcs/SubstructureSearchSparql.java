...
//            String limitingId = getSparqlEntity().getValue(GlycoSequenceSparql.AccessionNumber);
//            t_strSPARQL = "?glycan glytoucan:has_primary_id \"" + limitingId + "\" .\n";
//        }
//
//        WURCSSequence2ExporterSPARQL t_oExport = getExporter(getSparqlEntity().getValue(GlycoSequenceSparql.Sequence));
//
...
//                    + "FILTER (?primaryId != \"" + getSparqlEntity().getValue(GlycoSequenceSparql.AccessionNumber) + "\")";
//        }
//        return where;
//    }
//
